...
class FillBetweenPolyCollection(PolyCollection):
    def __init__(self, t_direction: Literal["x", "y"], t: ArrayLike, f1: ArrayLike, f2: ArrayLike, *, where: Sequence[bool] | None = ..., interpolate: bool = ..., step: Literal["pre", "post", "mid"] | None = ..., **kwargs) -> None:
        ...
    
    def set_data(self, t: ArrayLike, f1: ArrayLike, f2: ArrayLike, *, where: Sequence[bool] | None = ...) -> None:
        ...
