...
class FT2Font(Buffer):
    ...
    def draw_glyph_to_bitmap(self, image: FT2Image, x: int, y: int, glyph: Glyph, antialiased: bool = ...) -> None:
        ...
    ...
    def set_text(self, string: str, angle: float = ..., flags: LoadFlags = ...) -> NDArray[np.float64]:
        ...
