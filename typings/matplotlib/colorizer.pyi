...
class Colorizer:
    ...
    def __init__(self, cmap: str | colors.Colormap | None = ..., norm: str | colors.Normalize | None = ...) -> None:
        ...
...
class _ScalarMappable(_ColorizerInterface):
    def __init__(self, norm: colors.Normalize | None = ..., cmap: str | colors.Colormap | None = ..., *, colorizer: Colorizer | None = ..., **kwargs) -> None:
        ...
