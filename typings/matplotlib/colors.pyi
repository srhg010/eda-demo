...
class LinearSegmentedColormap(Colormap):
    ...
    @staticmethod
    def from_list(name: str, colors: ArrayLike | Sequence[tuple[float, ColorType]], N: int = ..., gamma: float = ...) -> LinearSegmentedColormap:
        ...
...
class MultivarColormap:
    ...
    @overload
    def __call__(self, X: Sequence[Sequence[float]] | np.ndarray, alpha: ArrayLike | None = ..., bytes: bool = ..., clip: bool = ...) -> np.ndarray:
        ...
    
    @overload
    def __call__(self, X: Sequence[float], alpha: float | None = ..., bytes: bool = ..., clip: bool = ...) -> tuple[float, float, float, float]:
        ...
    
    @overload
    def __call__(self, X: ArrayLike, alpha: ArrayLike | None = ..., bytes: bool = ..., clip: bool = ...) -> tuple[float, float, float, float] | np.ndarray:
        ...
    ...
    def with_extremes(self, *, bad: ColorType | None = ..., under: Sequence[ColorType] | None = ..., over: Sequence[ColorType] | None = ...) -> MultivarColormap:
        ...
...
class BivarColormap:
    ...
    M: int
    n_variates: int
    def __init__(self, N: int = ..., M: int | None = ..., shape: Literal['square', 'circle', 'ignore', 'circleignore'] = ..., origin: Sequence[float] = ..., name: str = ...) -> None:
        ...
    
    @overload
    def __call__(self, X: Sequence[Sequence[float]] | np.ndarray, alpha: ArrayLike | None = ..., bytes: bool = ...) -> np.ndarray:
        ...
    
    @overload
    def __call__(self, X: Sequence[float], alpha: float | None = ..., bytes: bool = ...) -> tuple[float, float, float, float]:
        ...
    ...
    def with_extremes(self, *, bad: ColorType | None = ..., outside: ColorType | None = ..., shape: str | None = ..., origin: None | Sequence[float] = ...) -> MultivarColormap:
        ...
    


class SegmentedBivarColormap(BivarColormap):
    def __init__(self, patch: np.ndarray, N: int = ..., shape: Literal['square', 'circle', 'ignore', 'circleignore'] = ..., origin: Sequence[float] = ..., name: str = ...) -> None:
        ...
    


class BivarColormapFromImage(BivarColormap):
    def __init__(self, lut: np.ndarray, shape: Literal['square', 'circle', 'ignore', 'circleignore'] = ..., origin: Sequence[float] = ..., name: str = ...) -> None:
        ...
